...
export const useSessions = () => {
  const listSessions = useCallback(async (appName: string, userId: string): Promise<SessionSimple[]> => {
    try {
  ...
  const getSession = useCallback(async (appName: string, userId: string, sessionId: string): Promise<Session> => {
    try {
  ...
  const deleteSession = useCallback(async (appName: string, userId: string, sessionId: string): Promise<void> => {
    try {
